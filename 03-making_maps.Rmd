...
```{python, warning=FALSE, results=TRUE}

# Read the SHP file
SA2_shp = gpd.read_file('ASGS/SA2_2021_AUST_SHP_GDA2020/SA2_2021_AUST_GDA2020.shp')    
...
SA2_shp_MEL = SA2_shp[SA2_shp['GCC_NAME21']=='Greater Melbourne'] 
SA2_shp_MEL.head()

# Quick plot of the shapefile
SA2_shp_MEL.plot(figsize=(20, 20), linewidth=0.1, edgecolor='0.9', legend = True)
